...
@KorRegistrationTextConfigDependency(dependsOnAtLeastOneOf = {
    @KorTextConfigDependency(filename = ModuleOre.Config.FILENAME, category = ModuleOre.Config.CATEGORY_BLOCK_ORE_NETHER, key = "aluminum_brass"),
    @KorTextConfigDependency(filename = ModuleOre.Config.FILENAME, category = ModuleOre.Config.CATEGORY_BLOCK_ORE_NETHER, key = "brass"),
    @KorTextConfigDependency(filename = ModuleOre.Config.FILENAME, category = ModuleOre.Config.CATEGORY_BLOCK_ORE_NETHER, key = "bronze"),
    @KorTextConfigDependency(filename = ModuleOre.Config.FILENAME, category = ModuleOre.Config.CATEGORY_BLOCK_ORE_NETHER, key = "constantan"),
    @KorTextConfigDependency(filename = ModuleOre.Config.FILENAME, category = ModuleOre.Config.CATEGORY_BLOCK_ORE_NETHER, key = "electrum"),
    @KorTextConfigDependency(filename = ModuleOre.Config.FILENAME, category = ModuleOre.Config.CATEGORY_BLOCK_ORE_NETHER, key = "enderium"),
    @KorTextConfigDependency(filename = ModuleOre.Config.FILENAME, category = ModuleOre.Config.CATEGORY_BLOCK_ORE_NETHER, key = "invar"),
    @KorTextConfigDependency(filename = ModuleOre.Config.FILENAME, category = ModuleOre.Config.CATEGORY_BLOCK_ORE_NETHER, key = "lumium"),
    @KorTextConfigDependency(filename = ModuleOre.Config.FILENAME, category = ModuleOre.Config.CATEGORY_BLOCK_ORE_NETHER, key = "signalum"),
    @KorTextConfigDependency(filename = ModuleOre.Config.FILENAME, category = ModuleOre.Config.CATEGORY_BLOCK_ORE_NETHER, key = "steel")
})

@KorGenerateBlockSubTypedAssets(
    property = "type",
    name = "nether_ore_alloy",
...
@KorGenerateLangEntries(entries = {
    @KorLangEntry(key = "tile.nether_ore_alloy_aluminum_brass.name", value = "Nether Alumina Brass Ore"),
    @KorLangEntry(key = "tile.nether_ore_alloy_brass.name", value = "Nether Brass Ore"),
    @KorLangEntry(key = "tile.nether_ore_alloy_constantan.name", value = "Nether Constantan Ore"),
    @KorLangEntry(key = "tile.nether_ore_alloy_electrum.name", value = "Nether Electrum Ore"),
    @KorLangEntry(key = "tile.nether_ore_alloy_enderium.name", value = "Nether Enderium Ore"),
    @KorLangEntry(key = "tile.nether_ore_alloy_invar.name", value = "Nether Invar Ore"),
    @KorLangEntry(key = "tile.nether_ore_alloy_lumium.name", value = "Nether Lumium Ore"),
    @KorLangEntry(key = "tile.nether_ore_alloy_signalum.name", value = "Nether Signalum Ore"),
    @KorLangEntry(key = "tile.nether_ore_alloy_steel.name", value = "Nether Steel Ore")
})
