...
public class WorldGenNetherOreEnderium extends
    KorWorldGen {
  ...
  private static class Config extends
    ...
    public Config() {
      super(
          ...
          new DimensionProfile(-1, 3, "minecraft:stone", new MinMaxInt(1, 1), new MinMaxInt(5, 115))
      );
    }
  }
  ...
  // --------------------------------------------------------------------------
  @KorInject
  public WorldGenNetherOreEnderium(
      Kor kor,
      @KorJsonConfig(path = ModuleOre.Config.OreGenNether.CONFIG_PATH, file = "enderium.json") Config config
  ) {
    super(
        config,
        kor.get(BlockNetherOre.class).getDefaultState().withProperty(BlockNetherOre.TYPE, MetalType.Enderium)
    );
  }
}
