package com.sudoplay.mc.kormetals.module.ore.blocks.ore.netherrack.alloy;
...
public class BlockNetherOreEnderium extends
    KorBlock {
  ...
  @KorInject
  public BlockNetherOreEnderium(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/ore", file = "nether_ore_enderium.json") Config config
  ) {
    super(
        kor.getModId(),
        "nether_ore_enderium",
