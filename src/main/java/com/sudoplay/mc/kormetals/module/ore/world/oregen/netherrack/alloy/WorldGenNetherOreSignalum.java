...
import com.sudoplay.mc.kormetals.module.ore.blocks.ore.netherrack.alloy.BlockNetherOreSignalum;
...
public class WorldGenNetherOreSignalum extends
  ...
  public WorldGenNetherOreSignalum(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/world", file = "nether_ore_signalum.json") Config config
  ) {
    super(
        config,
        kor.get(BlockNetherOreSignalum.class).getDefaultState()
    );
  }
}
