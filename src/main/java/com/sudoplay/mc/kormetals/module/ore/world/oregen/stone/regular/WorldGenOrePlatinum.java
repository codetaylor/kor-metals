...
import com.sudoplay.mc.kormetals.module.ore.blocks.ore.stone.regular.BlockOrePlatinum;
...
public class WorldGenOrePlatinum extends
  ...
  public WorldGenOrePlatinum(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/world", file = "ore_platinum.json") Config config
  ) {
    super(
        config,
        kor.get(BlockOrePlatinum.class).getDefaultState()
    );
  }
}
