...
import com.sudoplay.mc.kormetals.module.ore.blocks.ore.netherrack.alloy.BlockNetherOreInvar;
...
public class WorldGenNetherOreInvar extends
  ...
  public WorldGenNetherOreInvar(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/world", file = "nether_ore_invar.json") Config config
  ) {
    super(
        config,
        kor.get(BlockNetherOreInvar.class).getDefaultState()
    );
  }
}
