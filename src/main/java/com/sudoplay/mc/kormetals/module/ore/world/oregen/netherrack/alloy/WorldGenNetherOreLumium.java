...
import com.sudoplay.mc.kormetals.module.ore.blocks.ore.netherrack.alloy.BlockNetherOreLumium;
...
public class WorldGenNetherOreLumium extends
  ...
  public WorldGenNetherOreLumium(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/world", file = "nether_ore_lumium.json") Config config
  ) {
    super(
        config,
        kor.get(BlockNetherOreLumium.class).getDefaultState()
    );
  }
}
