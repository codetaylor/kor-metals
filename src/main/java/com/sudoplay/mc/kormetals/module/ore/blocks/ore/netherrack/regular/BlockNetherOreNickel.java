...
public class BlockNetherOreNickel extends
    KorBlock {
  ...
  @KorInject
  public BlockNetherOreNickel(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/ore", file = "nether_ore_nickel.json") Config config
  ) {
    super(
        kor.getModId(),
        "nether_ore_nickel",
