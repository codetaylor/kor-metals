...
import com.sudoplay.mc.kormetals.module.ore.blocks.ore.stone.alloy.BlockOreBrass;
...
public class WorldGenOreBrass extends
  ...
  public WorldGenOreBrass(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/world", file = "ore_brass.json") Config config
  ) {
    super(
        config,
        kor.get(BlockOreBrass.class).getDefaultState()
    );
  }
}
