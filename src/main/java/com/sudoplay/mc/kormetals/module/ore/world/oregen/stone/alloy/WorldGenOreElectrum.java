...
import com.sudoplay.mc.kormetals.module.ore.blocks.ore.stone.alloy.BlockOreElectrum;
...
public class WorldGenOreElectrum extends
  ...
  public WorldGenOreElectrum(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/world", file = "ore_electrum.json") Config config
  ) {
    super(
        config,
        kor.get(BlockOreElectrum.class).getDefaultState()
    );
  }
}
