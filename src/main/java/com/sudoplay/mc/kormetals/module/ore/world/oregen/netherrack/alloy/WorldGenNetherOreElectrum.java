...
import com.sudoplay.mc.kormetals.module.ore.blocks.ore.netherrack.alloy.BlockNetherOreElectrum;
...
public class WorldGenNetherOreElectrum extends
  ...
  private static class Config extends
    ...
    public Config() {
      super(
          ...
          new DimensionProfile(0, 3, "minecraft:stone", new MinMaxInt(1, 2), new MinMaxInt(35, 115))
      );
    }
  }
  ...
  public WorldGenNetherOreElectrum(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/world", file = "nether_ore_electrum.json") Config config
  ) {
    super(
        config,
        kor.get(BlockNetherOreElectrum.class).getDefaultState()
    );
  }
}
