...
@KorRegistrationTextConfigDependency(
    ...
    key = "nether_ore_lumium"
)

public class BlockNetherOreLumium extends
    KorBlock {
  ...
  @KorInject
  public BlockNetherOreLumium(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/ore", file = "nether_ore_lumium.json") Config config
  ) {
    super(
        kor.getModId(),
        "nether_ore_lumium",
