...
public class BlockNetherOrePlatinum extends
    KorBlock {
  ...
  @KorInject
  public BlockNetherOrePlatinum(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/ore", file = "nether_ore_platinum.json") Config config
  ) {
    super(
        kor.getModId(),
        "nether_ore_platinum",
