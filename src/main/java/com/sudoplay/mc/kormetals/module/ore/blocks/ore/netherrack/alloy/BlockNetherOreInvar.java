...
public class BlockNetherOreInvar extends
    KorBlock {
  ...
  @KorInject
  public BlockNetherOreInvar(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/ore", file = "nether_ore_invar.json") Config config
  ) {
    super(
        kor.getModId(),
        "nether_ore_invar",
