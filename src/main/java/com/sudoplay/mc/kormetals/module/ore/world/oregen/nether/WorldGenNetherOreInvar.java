...
public class WorldGenNetherOreInvar extends
    KorWorldGen {
  ...
  // --------------------------------------------------------------------------
  @KorInject
  public WorldGenNetherOreInvar(
      Kor kor,
      @KorJsonConfig(path = ModuleOre.Config.OreGenNether.CONFIG_PATH, file = "invar.json") Config config
  ) {
    super(
        config,
