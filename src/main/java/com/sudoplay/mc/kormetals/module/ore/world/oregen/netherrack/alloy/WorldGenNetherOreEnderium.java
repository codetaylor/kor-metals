...
import com.sudoplay.mc.kormetals.module.ore.blocks.ore.netherrack.alloy.BlockNetherOreEnderium;
...
public class WorldGenNetherOreEnderium extends
  ...
  private static class Config extends
    ...
    public Config() {
      super(
          ...
          new DimensionProfile(0, 3, "minecraft:stone", new MinMaxInt(1, 1), new MinMaxInt(5, 115))
      );
    }
  }
  ...
  public WorldGenNetherOreEnderium(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/world", file = "nether_ore_enderium.json") Config config
  ) {
    super(
        config,
        kor.get(BlockNetherOreEnderium.class).getDefaultState()
    );
  }
}
