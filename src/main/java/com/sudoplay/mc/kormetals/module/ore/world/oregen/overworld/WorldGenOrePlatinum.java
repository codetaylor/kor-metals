package com.sudoplay.mc.kormetals.module.ore.world.oregen.overworld;
...
public class WorldGenOrePlatinum extends
    KorWorldGen {
  ...
  private static class Config extends
    ...
    public Config() {
      super(
          ...
          new DimensionProfile(0, 3, "minecraft:stone", new MinMaxInt(1, 2), new MinMaxInt(11, 28))
      );
    }
  }
  ...
  // --------------------------------------------------------------------------
  @KorInject
  public WorldGenOrePlatinum(
      Kor kor,
      @KorJsonConfig(path = ModuleOre.Config.OreGenOverworld.CONFIG_PATH, file = "platinum.json") Config config
  ) {
    super(
        config,
