...
public class BlockNetherOreElectrum extends
    KorBlock {
  ...
  @KorInject
  public BlockNetherOreElectrum(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/ore", file = "nether_ore_electrum.json") Config config
  ) {
    super(
        kor.getModId(),
        "nether_ore_electrum",
