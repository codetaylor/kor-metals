package com.sudoplay.mc.kormetals.module.ore.world.oregen.nether;
...
import com.sudoplay.mc.kormetals.module.ore.blocks.ore.MetalType;
...
public class WorldGenNetherOreElectrum extends
    KorWorldGen {
  ...
  private static class Config extends
    ...
    public Config() {
      super(
          ...
          new DimensionProfile(-1, 3, "minecraft:stone", new MinMaxInt(1, 2), new MinMaxInt(35, 115))
      );
    }
  }
  ...
  // --------------------------------------------------------------------------
  @KorInject
  public WorldGenNetherOreElectrum(
      Kor kor,
      @KorJsonConfig(path = ModuleOre.Config.OreGenNether.CONFIG_PATH, file = "electrum.json") Config config
  ) {
    super(
        config,
        kor.get(BlockNetherOre.class).getDefaultState().withProperty(BlockNetherOre.TYPE, MetalType.Electrum)
    );
  }
}
