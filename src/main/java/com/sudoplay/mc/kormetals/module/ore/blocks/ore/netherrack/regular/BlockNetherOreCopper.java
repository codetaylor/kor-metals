...
public class BlockNetherOreCopper extends
    KorBlock {
  ...
  @KorInject
  public BlockNetherOreCopper(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/ore", file = "nether_ore_copper.json") Config config
  ) {
    super(
        kor.getModId(),
        "nether_ore_copper",
