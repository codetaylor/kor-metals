...
public class BlockNetherOreSignalum extends
    KorBlock {
  ...
  @KorInject
  public BlockNetherOreSignalum(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/ore", file = "nether_ore_signalum.json") Config config
  ) {
    super(
        kor.getModId(),
        "nether_ore_signalum",
