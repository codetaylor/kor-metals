...
public class WorldGenNetherOreNickel extends
  ...
  private static class Config extends
    ...
    public Config() {
      super(
          ...
          new DimensionProfile(-1, 6, "minecraft:netherrack", new MinMaxInt(4, 6), new MinMaxInt(10, 100))
      );
    }
  }
  ...
  public WorldGenNetherOreNickel(
      Kor kor,
      @KorJsonConfig(path = ModuleOre.Config.OreGenNether.CONFIG_PATH, file = "nickel.json") Config config
  ) {
    super(
        config,
        kor.get(BlockNetherOre.class).getDefaultState().withProperty(BlockNetherOre.TYPE, MetalType.Nickel)
    );
  }
}
