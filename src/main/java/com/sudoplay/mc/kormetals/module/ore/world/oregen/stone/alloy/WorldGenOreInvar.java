...
import com.sudoplay.mc.kormetals.module.ore.blocks.ore.stone.alloy.BlockOreInvar;
...
public class WorldGenOreInvar extends
  ...
  public WorldGenOreInvar(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/world", file = "ore_invar.json") Config config
  ) {
    super(
        config,
        kor.get(BlockOreInvar.class).getDefaultState()
    );
  }
}
