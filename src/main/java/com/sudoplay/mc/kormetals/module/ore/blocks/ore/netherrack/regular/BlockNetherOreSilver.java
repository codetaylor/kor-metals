...
public class BlockNetherOreSilver extends
    KorBlock {
  ...
  @KorInject
  public BlockNetherOreSilver(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/ore", file = "nether_ore_silver.json") Config config
  ) {
    super(
        kor.getModId(),
        "nether_ore_silver",
