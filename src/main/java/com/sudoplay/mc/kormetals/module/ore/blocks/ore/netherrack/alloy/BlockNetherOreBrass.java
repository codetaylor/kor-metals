...
public class BlockNetherOreBrass extends
    KorBlock {
  ...
  @KorInject
  public BlockNetherOreBrass(
      Kor kor,
      @KorConfig(path = ModuleOre.MODULE_ID + "/ore", file = "nether_ore_brass.json") Config config
  ) {
    super(
        kor.getModId(),
        "nether_ore_brass",
